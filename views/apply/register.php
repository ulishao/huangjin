        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" method="post" action=""/>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="email" class="form-control" id="firstname" name="email" placeholder="请输入邮箱地址">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" onclick="submit()" class="btn btn-default">点击发送邮件注册</button>
                    </div>
                </div>
            </form>
        </div>
...
//            var txt = $("#email").val();
//
//            $.post("/login/register",{username:txt},function(result){
//                console.log(result)
