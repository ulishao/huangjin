...
<!--                    <div class="col-sm-10">-->
<!--                        <input type="text" id="email" class="form-control" id="firstname" placeholder="请输入邮箱地址">-->
<!--                    </div>-->
<!--                </div>-->
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" onclick="submit()" class="btn btn-default"><?php echo $email;?></button>
                    </div>
                </div>
            </form>
        </div>
